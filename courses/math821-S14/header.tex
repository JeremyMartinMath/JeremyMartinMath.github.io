...
\usepackage{amssymb,amsmath,amsthm,graphics,hyperref,mathrsfs,stmaryrd,psfrag,dsfont,youngtab,framed,blkarray}
\usepackage[all]{xy}
\numberwithin{equation}{section}

\newcommand{\daymarker}[1]{\hrule\fbox{\bf {#1}}}
...
\newcommand{\bigpad}{\rule[-14mm]{0mm}{30mm}} % insert vertical spacing
